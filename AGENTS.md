...
**Codex scaffolds, Drishan publishes.** Every drafted note, plate, or
...
live in `.Codex/skills/` (`draft-note`, `publish-note`) — invoke them.
...
Do not add Codex/AI attribution or co-author trailers to commit messages.
