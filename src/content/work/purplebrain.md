...
specifically, it drives an FM synthesis engine from features pulled out of brainwave data.
The goal was to make the mapping feel *immediate*, *intuitive*, and *fun*: move your
...
We used OpenBCI biosensing boards hooked to a 10-channel EEG.
I built the signal path in Max/MSP to keep the it visually readable. OpenBCI 
pulls out band power and other features, Max ingests them using the OSC protocol,
and we map them onto FM synthesis parameters —
