...
Field manual: three real errors, in the order you'll meet them,
...
Two WSL facts worth knowing before they surprise us later:
...
- The Windows filesystem is mounted at `/mnt/c`, and it's *slow* for the
  ...
  `/mnt/c` if you like (I do so Windows tools can see it), but put the
